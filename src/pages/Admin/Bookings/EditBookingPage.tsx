...
import { useBooking, useUpdateBooking } from "@/hooks/useBookingApi";
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Update booking details for {booking.guestName}
            </p>
          </div>
        </div>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex justify-end gap-4">
                  ...
                  <Button
                    type="submit"
                    disabled={updateBookingMutation.isPending || !dateRange?.from || !dateRange?.to}
                  >
