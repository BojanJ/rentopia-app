...
export function PropertySwitcher() {
  ...
  // Use the properties hook to load data
        ...
        <SidebarMenuItem>
          ...
          >
            ...
            <div className="grid flex-1 text-left text-sm leading-tight">
              ...
              <span className="truncate text-xs text-muted-foreground">Loading properties</span>
            </div>
          </SidebarMenuButton>
        </SidebarMenuItem>
      </SidebarMenu>
        ...
        <SidebarMenuItem>
          ...
          >
            ...
            <div className="grid flex-1 text-left text-sm leading-tight">
              ...
              <span className="truncate text-xs text-muted-foreground">No properties yet</span>
            </div>
          </SidebarMenuButton>
        </SidebarMenuItem>
      </SidebarMenu>
        ...
        <DropdownMenu>
          ...
          >
            ...
            {activeProperties.map((property, index) => {
              const { Icon: PropertyIcon, location: propertyLocation, occupancy: propertyOccupancy } = getPropertyDisplayInfo(property);
            ...
            <DropdownMenuItem className="gap-2 p-3">
              ...
              <div className="text-muted-foreground font-medium">Add property</div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </SidebarMenuItem>
